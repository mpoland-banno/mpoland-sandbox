...
class SpeciesListUiStateHolderPreviewParameter: PreviewParameterProvider<SpeciesListUiStateHolder> {
    companion object {
        private val BOGUS_FISH_LIST = listOf(
            Species("Fish One", "Latin Fish One", "/fish-one", SpeciesImageData.DefaultImageData),
            Species("Fish Two", "Latin Fish Two", "/fish-two", SpeciesImageData.DefaultImageData),
            Species("Fish Three", "Latin Fish Three", "/fish-three", SpeciesImageData.DefaultImageData),
            Species("Fish Four", "Latin Fish Four", "/fish-four", SpeciesImageData.DefaultImageData),
            Species("Fish Five", "Latin Fish Five", "/fish-five", SpeciesImageData.DefaultImageData)
        )
